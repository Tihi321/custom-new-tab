// Custom New Tab - New Tab Page Script

// Redirect to custom URL or show default page
(function() {
  console.log("Custom New Tab extension loaded");
  ...
  chrome.storage.sync.get(["customUrl", "isEnabled"], (result) => {
    ...
    console.log("isEnabled:", isEnabled, "customUrl:", customUrl);
    
    if (isEnabled && customUrl) {
      // Redirect to the custom URL immediately
      ...
      console.log("Custom URL is disabled, showing default page");
